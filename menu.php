		...
		<div id="myModal" class="modal">
			...
			<div class="modal-content">
				...
				<div class="mySlides">
					...
					<img class="demo" src="images/menu/large/Hibiscus.jpg" alt="Hibiscus">
				</div>
				<div class="mySlides">
					<div class="numbertext">2 / 18</div>
					<img class="demo" src="images/menu/large/Toasted Coconut.jpg" alt="Toasted Coconut">
				</div>
				<div class="mySlides">
					<div class="numbertext">3 / 18</div>
					<img class="demo" src="images/menu/large/Dulce de Leche - Almonds.jpg" alt="Dulce de Leche - Almonds">
				</div>
				<div class="mySlides">
					<div class="numbertext">4 / 18</div>
					<img class="demo" src="images/menu/large/Cheesecake.jpg" alt="Cheesecake">
				</div>
				<div class="mySlides">
					<div class="numbertext">5 / 18</div>
					<img class="demo" src="images/menu/large/Matcha - Sugar.jpg" alt="Matcha - Sugar">
				</div>
				<div class="mySlides">
					<div class="numbertext">6 / 18</div>
					<img class="demo" src="images/menu/large/Double Chocolate Brownie.jpg" alt="Double Chocolate Brownie">
				</div>
				<div class="mySlides">
					<div class="numbertext">7 / 18</div>
					<img class="demo" src="images/menu/large/Chocolate-Earl Grey.jpg" alt="Chocolate-Earl Grey">
				</div>
				<div class="mySlides">
					<div class="numbertext">8 / 18</div>
					<img class="demo" src="images/menu/large/Black and White.jpg" alt="Black and White">
				</div>
				<div class="mySlides">
					<div class="numbertext">9 / 18</div>
					<img class="demo" src="images/menu/large/Lemon-Ginger.jpg" alt="Lemon-Ginger">
				</div>
				<div class="mySlides">
					<div class="numbertext">10 / 18</div>
					<img class="demo" src="images/menu/large/Mixed Berry.jpg" alt="Mixed Berry">
				</div>
				<div class="mySlides">
					<div class="numbertext">11 / 18</div>
					<img class="demo" src="images/menu/large/Pumpkin.jpg" alt="Pumpkin">
				</div>
				<div class="mySlides">
					<div class="numbertext">12 / 18</div>
					<img class="demo" src="images/menu/large/Chocolate-Cocoa Nib.jpg" alt="Chocolate-Cocoa Nib">
				</div>
				<div class="mySlides">
					<div class="numbertext">13 / 18</div>
					<img class="demo" src="images/menu/large/Mojito.jpg" alt="Mojito">
				</div>
				<div class="mySlides">
					<div class="numbertext">14 / 18</div>
					<img class="demo" src="images/menu/large/Gin & Tonic.jpg" alt="Gin & Tonic">
				</div>
				<div class="mySlides">
					<div class="numbertext">15 / 18</div>
					<img class="demo" src="images/menu/large/Chocolate Chipotle.jpg" alt="Chocolate Chipotle">
				</div>
				<div class="mySlides">
					<div class="numbertext">16 / 18</div>
					<img class="demo" src="images/menu/large/Chocolate Stout.jpg" alt="Chocolate Stout">
				</div>
				<div class="mySlides">
					<div class="numbertext">17 / 18</div>
					<img class="demo" src="images/menu/large/Passion Fruit.jpg" alt="Passion Fruit">
				</div>
				<div class="mySlides">
					<div class="numbertext">18 / 18</div>
					<img class="demo" src="images/menu/large/Mocha-Almond Crunch.jpg" alt="Mocha-Almond Crunch">
				</div>
